...
const MakeDeck = ({ onAddToCollection, collection, user }) => {
  ...
  return (
    <>
      <div className='home-title-container bg-gradient-to-r from-yellow-300 to-pink-200 via-transparent rounded-2xl p-4 m-2'>
      ...
      <div className='flex flex-wrap flex-col w-full h-full overflow-y-scroll'>
        {offerStronger &&
            ...
            return (
              <div className='flex flex-col items-center' key={index}>
                ...
                {collection && !collection?.includes(poki) ? (
                  <button
                    className='collection-btw m-auto w-[112px] max-h-[60px] rounded-xl shadow-sm bg-accent hover:bg-accent-dark'
